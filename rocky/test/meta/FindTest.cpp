...
TEST_CASE("IsOneOf", "[Find]")
{
    static_assert(!IsOneOf<int>(), "doesn't have 'int' type.");
    static_assert(!IsOneOf<int, char, char, char, char, char>(), "doesn't have 'int' type.");
    static_assert(IsOneOf<int, int, char, char, char, char>(), "'int' type at '0'.");
    static_assert(IsOneOf<int, char, char, char, char, int>(), "'int' type at '4'.");
    static_assert(IsOneOf<int, char, char, int, char, char>(), "'int' type at '2'.");
    static_assert(
            IsOneOf<
                    int,
                    char, int, char, int, char, char, char
...
TEST_CASE("IsOneOf with tuple", "[Find]")
{
    using std::is_same;
    using std::tuple;
    ...
    {
        using tuple_t = tuple<>;
        static_assert(!IsOneOf<int, tuple_t>(), "tuple_t doesn't have 'int' type.");
    }
    ...
    {
        using tuple_t = tuple<int, char, char, char, char>;
        static_assert(IsOneOf<int, tuple_t>(), "tuple_t has 'int' type at '0'.");
    }

    {
        using tuple_t = tuple<char, char, char, char, int>;
        static_assert(IsOneOf<int, tuple_t>(), "tuple_t has 'int' type at '4'.");
    }

    {
        using tuple_t = tuple<char, char, int, char, char>;
        static_assert(IsOneOf<int, tuple_t>(), "tuple_t has 'int' type at '2'.");
    }

    {
        using tuple_t = tuple<char, int, char, int, char, char, char>;
        static_assert(IsOneOf<int, tuple_t>(), "tuple_t has the last 'int' type at '3'.");
    }
}
