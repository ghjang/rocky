...
TEST_CASE("counting integral type", "[CountIf]")
{
    ...
    static_assert(
            CountIf<Quote<is_integral>, char, int, float, double, uint64_t>() == 3,
            "the number of integral types is 3."
    );

    static_assert(
            CountIf<Quote<is_integral>, TypeList<char, int, float, double, uint64_t>>() == 3,
            "the number of integral types is 3."
    );
}
...
TEST_CASE("counting pointer type", "[CountIf]")
{
    ...
    static_assert(
            CountIf<Quote<is_pointer>, char, int *, float, double *, uint64_t>() == 2,
...
TEST_CASE("counting integral type of tuple", "[CountIf]")
{
    ...
    static_assert(
            CountIf<Quote<is_integral>, tuple_t>() == 3,
...
TEST_CASE("counting pointer type of tuple", "[CountIf]")
{
    ...
    using tuple_t = tuple<char, int *, float, double *, uint64_t>;
    static_assert(
            CountIf<Quote<is_pointer>, tuple_t>() == 2,
