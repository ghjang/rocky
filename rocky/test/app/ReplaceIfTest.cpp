...
TEST_CASE("replace tuple element type with condition", "[ReplaceIf]")
{
    ...
    static_assert(
            is_same<
                    ...
                    ReplaceIfT<is_floating_point, int *, char, int, float, double, int>
            >(),
            ""
    );
    ...
    static_assert(
            is_same<
                    TypeList<char, int, int *, int *, int>,
                    ReplaceIfT<is_floating_point, int *, TypeList<char, int, float, double, int>>
            >(),
            ""
    );

    static_assert(
            is_same<replaced_tuple_t, ReplaceIfT<is_floating_point, int *, tuple_t>>(),
